...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  },
  {
    ...
    description: 'Transfer a deposit between properties or landlords',
    endpoint: '/services/apexrest/transferdeposit',
    method: 'POST',
    category: 'Deposit Management',
  },
  {
    ...
    description: 'Transfer a deposit from one branch to another branch',
    endpoint: '/services/apexrest/transferbranch/{DAN}',
    method: 'POST',
    category: 'Deposit Management',
    requiresPathParam: true,
    pathParamName: 'DAN',
    pathParamPlaceholder: 'NI1022709',
  },
  {
    id: 'all-tenancies',
